      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {services.map((s, i) => (
          ...
          >
            <TiltCard
              maxTilt={6}
              className="group relative h-full p-8 md:p-10 rounded-3xl bg-ink/3 border border-ink/10 hover:border-ink/25 hover:bg-cream/70 transition-colors duration-500 flex flex-col justify-between hover:shadow-[0_20px_50px_-15px_rgba(155,142,199,0.25)]"
            >
              <div>
